...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullName) {
        ...
        AbstractSection experience = new CompanySection(Arrays.asList(
                ...
                new Company("Wrike", "http://www.wrike.com",
                        Collections.singletonList(new Company.Period(LocalDate.of(2014, 10, 1),
                                LocalDate.of(2016, 1, 1),
                                "Старший разработчик (backend)",
                                "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."))),

                new Company("RIT Center", null,
                        Collections.singletonList(new Company.Period(LocalDate.of(2012, 4, 1),
                ...
                new Company("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
                        Collections.singletonList(new Company.Period(LocalDate.of(2010, 12, 1),
                                LocalDate.of(2012, 4, 1),
                                "Ведущий программист",
                                "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5."))),

                new Company("Yota", "https://www.yota.ru/",
                        Collections.singletonList(new Company.Period(LocalDate.of(2008, 6, 1),
                                LocalDate.of(2010, 12, 1),
                                "Ведущий специалист",
                                "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)"))),

                new Company("Enkata", "http://enkata.com/",
                        Collections.singletonList(new Company.Period(LocalDate.of(2007, 3, 1),
                                LocalDate.of(2008, 6, 1),
                                "Разработчик ПО",
                                "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining)."))),

                new Company("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
                        Collections.singletonList(new Company.Period(LocalDate.of(2005, 1, 1),
                                LocalDate.of(2007, 2, 1),
                                "Разработчик ПО",
                                "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix)."))),

                new Company("Alcatel", "http://www.alkatel.ru",
                        Collections.singletonList(new Company.Period(LocalDate.of(1997, 9, 1),
        ...
        AbstractSection education = new CompanySection(Arrays.asList(
                new Company("Coursera", "https://www.coursera.org/course/progfun",
                        Collections.singletonList(new Company.Period(LocalDate.of(2013, 3, 1),
                                LocalDate.of(2013, 5, 1),
                                "\"Functional Programming Principles in Scala\" by Martin Odersky",
                                ""))),

                new Company("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                        Collections.singletonList(new Company.Period(LocalDate.of(2011, 3, 1),
                ...
                new Company("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                        "http://www.ifmo.ru/",
                        Arrays.asList(
                                new Company.Period(LocalDate.of(1987, 9, 1),
                ...
                new Company("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/",
                        Collections.singletonList(new Company.Period(LocalDate.of(1984, 9, 1),
