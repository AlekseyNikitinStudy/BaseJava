...
import ru.javawebinar.basejava.modelSE.*;
...
public class ResumeTestDataSE {
    public static void main(String[] args) {
        ...
        Section experience = new CompanySection(Arrays.asList(
                ...
                new Company("Wrike",
                        Collections.singletonList(new Period(LocalDate.of(2014, 10, 1),
                                LocalDate.of(2016, 1, 1),
                                "Старший разработчик (backend)",
                                "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."))),

                new Company("Yota",
                        Collections.singletonList(new Period(LocalDate.of(2008, 6, 1),
                                LocalDate.of(2016, 1, 1),
                                "Ведущий специалист",
                                "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)"))),

                new Company("Enkata",
                        Collections.singletonList(new Period(LocalDate.of(2007, 3, 1),
                                LocalDate.of(2008, 6, 1),
                                "Разработчик ПО",
                                "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining)."))),

                new Company("Siemens AG",
                        Collections.singletonList(new Period(LocalDate.of(2005, 1, 1),
                                LocalDate.of(2007, 2, 1),
                                "Разработчик ПО",
                                "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix)."))),

                new Company("Alcatel",
                        Collections.singletonList(new Period(LocalDate.of(1997, 9, 1),
        ...
        Section education = new CompanySection(Arrays.asList(
                ...
                new Company("Luxoft",
                        Collections.singletonList(new Period(LocalDate.of(2011, 3, 1),
                ...
                new Company("Заочная физико-техническая школа при МФТИ",
                        Collections.singletonList(new Period(LocalDate.of(1984, 9, 1),
